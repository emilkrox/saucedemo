...
public class AddAllItemToCardAndCompleteOrder {
    ...
    public void addToCardOneItemTest() {
        ...
        mainPage.addCartBikeLightsBtn().click();
        mainPage.addCartOnesieBtn().click();
        mainPage.addCartBoltTShirt_Btn().click();
        mainPage.addCartJacketBtn().click();
        mainPage.addCartRedTShirtBtn().click();
